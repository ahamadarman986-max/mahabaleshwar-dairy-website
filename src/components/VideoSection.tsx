      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          <iframe 
            width="100%" 
            height="100%" 
            src="https://www.youtube.com/embed/pEb_fwidR8Q?autoplay=1&mute=1&loop=1&playlist=pEb_fwidR8Q&controls=0&showinfo=0&modestbranding=1" 
            title="Mahabaleshwor Dairy Video" 
            frameBorder="0" 
